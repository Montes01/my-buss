...
export default function page() {
  return (
    <>
      <div className="text-white relative rounded-xl w-full h-full backdrop-brightness-90 px-12 flex flex-col gap-12 backdrop-blur-2xl p-12 justify-center items-center">
